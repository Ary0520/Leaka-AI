...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @Leaka AI/sdk

# or
yarn add @Leaka AI/sdk
pnpm add @Leaka AI/sdk`,
  },
  {
    label: "Initialize",
    code: `import { Leaka AI } from '@Leaka AI/sdk'

const Leaka AI = new Leaka AI({
  apiKey: process.env.Leaka AI_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await Leaka AI.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
