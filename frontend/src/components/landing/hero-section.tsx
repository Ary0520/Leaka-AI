...
const words = ["test", "verify", "secure", "ship"];
    ...
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Your autonomous QA agent to stop maintaining brittle scripts and start shipping. 
            Securely test, verify, and scale your revenue flows.
          </p>
      ...
      <div 
        className={`absolute bottom-8 lg:bottom-12 left-0 right-0 transition-all duration-700 delay-500 ${
